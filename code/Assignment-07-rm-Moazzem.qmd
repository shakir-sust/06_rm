...
*Interpretation:* In the QQ plot for the random effect associated with potassium rates nested within blocks shown above, the residuals appear to fall closely around the QQ line with no strong curvature pattern. Although there appears to be a little bit deviations from QQ line on two tails, they are not too extreme to be worrisome. Hence, the residual normality assumption for the Block random effects appear to hold.
